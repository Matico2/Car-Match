...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialCardView materialIcon;
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonLogin,
      @NonNull ImageView imageIcon, @NonNull ConstraintLayout imgProfile,
      @NonNull MaterialCardView materialIcon, @NonNull TextInputLayout textInputEmail,
      @NonNull TextInputLayout textInputPassword, @NonNull TextView textViewCopyright,
      @NonNull TextView textViewForgotPassword, @NonNull TextView textViewRegister) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.materialIcon;
      MaterialCardView materialIcon = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, buttonLogin, imageIcon,
          imgProfile, materialIcon, textInputEmail, textInputPassword, textViewCopyright,
          textViewForgotPassword, textViewRegister);
    }
